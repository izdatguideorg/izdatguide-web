...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={classnames(styles.scrollUpButton, className)}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ref={ref}
    className={classnames(styles.scrollDownButton, className)}
    {...props}
  >
    <ChevronDown className={styles.chevronDown} />
  </SelectPrimitive.ScrollDownButton>
  ...
  <SelectPrimitive.Portal>
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={classnames(styles.view, position === 'popper' && styles.viewPopper)}
      >
        {children}
      </SelectPrimitive.Viewport>
